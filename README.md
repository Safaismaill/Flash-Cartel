...
1. Go to https://www.php.net/downloads.php and download the Thread-safe Zip folder.
2. Extract all the files from the downloaded ZIP file.
3. Cut the folder, and paste it into Program FIles, on your C drive.
4. Open the folder in File Manager. Click on the search bar of File Manager, and copy the path from it, eg. C:\Program Files\php-8.5.3
...
11. If it doesn't, restart your computer, re-enter CMD, and try "php --version" again.
